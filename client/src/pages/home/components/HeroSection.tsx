...
const HeroSection = () => {
  return (
    <>
      ...
      <div className="dark:bg-neutral-900 bg-inherit">
        <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
          <h1 className="font-semibold dark:text-white text-black text-5xl md:text-6xl">
            <span className="text-primary dark:text-primary">Aquaponics:</span>{" "}
            Discover Memorable Events
          </h1>
          <div className="max-w-4xl">
            <p className="mt-5 dark:text-neutral-50 text-neutral-700 text-lg">
              At Aquaponics, we're passionate about creating unforgettable
              experiences. Whether you're planning a corporate conference, a
              wedding, or a community fundraiser, we've got you covered. Explore
              our services and find the perfect event solution for your needs.
            </p>
          </div>
        </div>
      </div>
      <div className="relative overflow-hidden pt-4 bg-inherit dark:bg-neutral-900">
        <svg
        ...
        <div className="relative z-10">
          <div className="max-w-5xl px-4 xl:px-0 mx-auto">
            <div className="mb-4">
              <h2 className="dark:text-neutral-50 text-neutral-700">
                Trusted by Corporations, Communities, and more than 1,000 of
                you!
              </h2>
            </div>

            <div className="flex justify-between gap-6">
              <FaBuilding className="py-3 lg:py-5 w-10 h-auto md:w-20 lg:w-10 dark:text-neutral-50 text-neutral-700" />

              <FaPeopleGroup className="py-3 lg:py-5 w-10 h-auto md:w-20 lg:w-10 dark:text-neutral-50 text-neutral-700" />

              <FaUser className="py-3 lg:py-5 w-10 h-auto md:w-20 lg:w-10 dark:text-neutral-50 text-neutral-700" />
            </div>
          </div>
        </div>
      </div>
